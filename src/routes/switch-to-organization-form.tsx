...
export const Route = createFileRoute("/switch-to-organization-form")({ component: Page });

function Page() {
  return (
    <div className="mx-auto max-w-5xl">
      <PageHeader title="Organization Details" subtitle="Tell us about your business" />
