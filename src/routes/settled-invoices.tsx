...
export const Route = createFileRoute("/settled-invoices")({ component: Page });

function Page() {
  const items = invoices.filter((i) => i.status === "settled");
  return (
    <div>
      <PageHeader title="Settled Invoices" subtitle="Completed settlements" />
      {items.length === 0 ? (
