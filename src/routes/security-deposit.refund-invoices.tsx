...
export const Route = createFileRoute("/security-deposit/refund-invoices")({ component: Page });
function Page() {
  const items = invoices.filter((i) => i.type === "refund");
  return (
    <div>
      <PageHeader title="Refund Invoices" subtitle="Inbound refund payments" />
