...
export const Route = createFileRoute("/my-offers")({ component: Page });

function Page() {
  const items = myOffers.filter((o) => true);
  return (
    <div>
      <PageHeader title="My Offers" subtitle="All your offer activity" />
      {items.length === 0 ? (
        <EmptyState icon={Tag} title="No offers yet" description="Your my offers will show up here." />
      ) : (
