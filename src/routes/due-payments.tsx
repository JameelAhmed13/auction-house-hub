...
export const Route = createFileRoute("/due-payments")({ component: Page });

function Page() {
  const items = invoices.filter((i) => i.status === "due");
  return (
    <div>
      <PageHeader title="Due Payments" subtitle="Outstanding balances" />
      {items.length === 0 ? (
