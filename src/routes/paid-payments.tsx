...
export const Route = createFileRoute("/paid-payments")({ component: Page });

function Page() {
  const items = invoices.filter((i) => i.status === "paid");
  return (
    <div>
      <PageHeader title="Paid Payments" subtitle="Cleared invoices" />
      {items.length === 0 ? (
